...
public class ChartPanel extends JPanel implements ChartChangeListener,
	...
	public void setMouseWheelEnabled(boolean flag) {
		if (flag && this.mouseWheelHandler == null) {
			...
			try {
				...
				Constructor cc = c
						.getConstructor(new Class[] { ChartPanel.class });
	...
	protected JPopupMenu createPopupMenu(boolean properties, boolean copy,
		...
		JPopupMenu result = new JPopupMenu(
				localizationResources.getString("Chart") + ":");
		...
		if (zoom) {
			...
			this.zoomOutDomainMenuItem
					.setActionCommand(ZOOM_OUT_DOMAIN_COMMAND);
			...
			this.zoomResetBothMenuItem = new JMenuItem(
					localizationResources.getString("All_Axes"));
			this.zoomResetBothMenuItem
					.setActionCommand(ZOOM_RESET_BOTH_COMMAND);
			...
			this.zoomResetRangeMenuItem = new JMenuItem(
					localizationResources.getString("Range_Axis"));
			this.zoomResetRangeMenuItem
					.setActionCommand(ZOOM_RESET_RANGE_COMMAND);
